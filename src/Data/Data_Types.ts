...
import { Line_Chart, Line_Chart_Options, Line_Chart_State, Line_Char_Data, Property_Generator } from "./LineChart/LineChart_Types";
import { Vector_Field, Vector_Field_Options, Vector_Field_State, Vector_Property_Generator } from "./VectorField/Vector_Field_Types";
...
export type Partialize<T> = {
    [P in keyof T] ?: 
        ...
        T[P] extends Field_Position<infer W> ? T[P] : 
