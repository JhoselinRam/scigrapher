...
function Line({dataHandler, dataState} : Line_Chart_Method_Generator) : Line {
...
//----------------- Enable --------------------
    ...
    function lineEnable(enable : boolean, callback?:(handler?:Line_Chart)=>void) : Line_Chart;
    function lineEnable(arg : void) : boolean;
    function lineEnable(enable : boolean | void, callback?:(handler?:Line_Chart)=>void) : Line_Chart | boolean | undefined{
...
//--------------- Generator -------------------
    ...
    function generateLineModifier<T>(container:Property_Generator<T>, property:Line_Properties) : Property_Modifier<T>{
        ...
        function lineProperty(value : Property_Generator<T>, callback?:(handler?:Line_Chart)=>void) : Line_Chart;
        function lineProperty(arg : void) : T | Array<T>;
        function lineProperty(value : Property_Generator<T> | void, callback?:(handler?:Line_Chart)=>void) : Line_Chart | T | Array<T> | undefined{
