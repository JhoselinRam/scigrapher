...
export interface Data_Vector{
    ...
    meshX : Position_Method_Generator,
    meshY : Position_Method_Generator,
    axisUsed : {
...
export type Position_Method_Generator = {
    (data:Field_Position<Vector_Field>, callback?:Vector_Field_Callback) : Vector_Field,
