...
import { Data_Method_Generator, Data_Vector } from "./Data_Vector_Types";
...
const meshX = generateDataMethod(dataState.mesh, "x", dataHandler, graphHandler, dataState);
const meshY = generateDataMethod(dataState.mesh, "y", dataHandler, graphHandler, dataState);
